...
- **Reality конфигов:** 355 конфигов
- **Последнее обновление:** 2026-04-25 03:26:55
...
Подписка будет автоматически обновляться, так как ссылка ведет на файл в GitHub.
В Hiddify можно настроить интервал автообновления.
...
### Clash Meta
1. Используйте URL подписки в поле `url` в конфиге
2. Или добавьте через интерфейс "Удаленные конфиги"
